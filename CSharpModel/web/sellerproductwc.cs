...
namespace GeneXus.Programs {
   public class sellerproductwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0O0( )
      {
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSellerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")), StringUtil.LTrim( ((edtSellerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9") : context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerId_Jsonclick, 0, "Attribute", "", "", "", "", edtSellerId_Visible, edtSellerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_SellerProductWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductPhoto))), !bGXsfl_12_Refreshing);
                              AssignProp(sPrefix, false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A23ProductPhoto), true);
      ...
      protected void RF0O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5SellerId = H000O2_A5SellerId[0];
               AssignAttri(sPrefix, false, "A5SellerId", StringUtil.LTrimStr( (decimal)(A5SellerId), 4, 0));
               A2CategoryName = H000O2_A2CategoryName[0];
               A1CategoryId = H000O2_A1CategoryId[0];
               A33ProductCountryName = H000O2_A33ProductCountryName[0];
               A9ProductCountryId = H000O2_A9ProductCountryId[0];
               A40000ProductPhoto_GXI = H000O2_A40000ProductPhoto_GXI[0];
               AssignProp(sPrefix, false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductPhoto))), !bGXsfl_12_Refreshing);
               AssignProp(sPrefix, false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A23ProductPhoto), true);
               A22ProductPrice = H000O2_A22ProductPrice[0];
               A21ProductDescription = H000O2_A21ProductDescription[0];
               A8ProductName = H000O2_A8ProductName[0];
               A7ProductId = H000O2_A7ProductId[0];
               A23ProductPhoto = H000O2_A23ProductPhoto[0];
               AssignProp(sPrefix, false, edtProductPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductPhoto)) ? A40000ProductPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductPhoto))), !bGXsfl_12_Refreshing);
               AssignProp(sPrefix, false, edtProductPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A23ProductPhoto), true);
               A2CategoryName = H000O2_A2CategoryName[0];
               A33ProductCountryName = H000O2_A33ProductCountryName[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130475586", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sellerproductwc.js", "?202211130475586", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductCountryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ProductCountryId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9ProductCountryId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductCountryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductCountryName_Internalname,StringUtil.RTrim( A33ProductCountryName),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductCountryName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl12( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A21ProductDescription));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A22ProductPrice, 12, 2, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A23ProductPhoto));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ProductCountryId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A33ProductCountryName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize( )
      {
         ...
         A2CategoryName = "";
         scmdbuf = "";
         H000O2_A5SellerId = new short[1] ;
         H000O2_A2CategoryName = new string[] {""} ;
         H000O2_A1CategoryId = new short[1] ;
         H000O2_A33ProductCountryName = new string[] {""} ;
         H000O2_A9ProductCountryId = new short[1] ;
         H000O2_A40000ProductPhoto_GXI = new string[] {""} ;
         H000O2_A22ProductPrice = new decimal[1] ;
         H000O2_A21ProductDescription = new string[] {""} ;
         H000O2_A8ProductName = new string[] {""} ;
         H000O2_A7ProductId = new short[1] ;
         H000O2_A23ProductPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sellerproductwc__default(),
            new Object[][] {
                new Object[] {
               H000O2_A5SellerId, H000O2_A2CategoryName, H000O2_A1CategoryId, H000O2_A33ProductCountryName, H000O2_A9ProductCountryId, H000O2_A40000ProductPhoto_GXI, H000O2_A22ProductPrice, H000O2_A21ProductDescription, H000O2_A8ProductName, H000O2_A7ProductId,
               H000O2_A23ProductPhoto
               }
               , new Object[] {
      ...
      private short[] H000O2_A5SellerId ;
      private string[] H000O2_A2CategoryName ;
      private short[] H000O2_A1CategoryId ;
      private string[] H000O2_A33ProductCountryName ;
      private short[] H000O2_A9ProductCountryId ;
      private string[] H000O2_A40000ProductPhoto_GXI ;
      private decimal[] H000O2_A22ProductPrice ;
      private string[] H000O2_A21ProductDescription ;
      private string[] H000O2_A8ProductName ;
      private short[] H000O2_A7ProductId ;
      private string[] H000O2_A23ProductPhoto ;
