...
namespace GeneXus.Programs {
   public class shoppingcartproductwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0M0( )
      {
         ...
         if ( wbEnd == 12 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtShoppingCartId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A11ShoppingCartId), 4, 0, ".", "")), StringUtil.LTrim( ((edtShoppingCartId_Enabled!=0) ? context.localUtil.Format( (decimal)(A11ShoppingCartId), "ZZZ9") : context.localUtil.Format( (decimal)(A11ShoppingCartId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtShoppingCartId_Jsonclick, 0, "Attribute", "", "", "", "", edtShoppingCartId_Visible, edtShoppingCartId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_ShoppingCartProductWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11ShoppingCartId = H000M2_A11ShoppingCartId[0];
               AssignAttri(sPrefix, false, "A11ShoppingCartId", StringUtil.LTrimStr( (decimal)(A11ShoppingCartId), 4, 0));
               A1CategoryId = H000M2_A1CategoryId[0];
               A8ProductName = H000M2_A8ProductName[0];
               A7ProductId = H000M2_A7ProductId[0];
               A2CategoryName = H000M2_A2CategoryName[0];
               A22ProductPrice = H000M2_A22ProductPrice[0];
               A31QtyProduct = H000M2_A31QtyProduct[0];
               A1CategoryId = H000M2_A1CategoryId[0];
               A8ProductName = H000M2_A8ProductName[0];
               A22ProductPrice = H000M2_A22ProductPrice[0];
               A2CategoryName = H000M2_A2CategoryName[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130475098", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("shoppingcartproductwc.js", "?202211130475099", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7ProductId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A7ProductId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoryId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CategoryId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1CategoryId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoryId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl12( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A7ProductId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A8ProductName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A22ProductPrice, 12, 2, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31QtyProduct), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A30TotalProduct, 12, 2, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CategoryId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A2CategoryName));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize( )
      {
         ...
         A2CategoryName = "";
         scmdbuf = "";
         H000M2_A11ShoppingCartId = new short[1] ;
         H000M2_A1CategoryId = new short[1] ;
         H000M2_A8ProductName = new string[] {""} ;
         H000M2_A7ProductId = new short[1] ;
         H000M2_A2CategoryName = new string[] {""} ;
         H000M2_A22ProductPrice = new decimal[1] ;
         H000M2_A31QtyProduct = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.shoppingcartproductwc__default(),
            new Object[][] {
                new Object[] {
               H000M2_A11ShoppingCartId, H000M2_A1CategoryId, H000M2_A8ProductName, H000M2_A7ProductId, H000M2_A2CategoryName, H000M2_A22ProductPrice, H000M2_A31QtyProduct
               }
               , new Object[] {
      ...
      private short[] H000M2_A11ShoppingCartId ;
      private short[] H000M2_A1CategoryId ;
      private string[] H000M2_A8ProductName ;
      private short[] H000M2_A7ProductId ;
      private string[] H000M2_A2CategoryName ;
      private decimal[] H000M2_A22ProductPrice ;
      private short[] H000M2_A31QtyProduct ;
