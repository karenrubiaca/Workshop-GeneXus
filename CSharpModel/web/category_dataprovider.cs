...
namespace GeneXus.Programs {
   public class category_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "TallerJAP2022KarenRubiaca") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBCCollection<SdtCategory> aP0_ReturnValue )
      {
         ...
         objcategory_dataprovider.AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "TallerJAP2022KarenRubiaca") ;
         objcategory_dataprovider.context.SetSubmitInitialConfig(context);
         objcategory_dataprovider.initialize();
         Submit( executePrivateCatch,objcategory_dataprovider);
         aP0_ReturnValue=this.AV2ReturnValue;
      }
      ...
      {
         AV2ReturnValue = new GXBCCollection<SdtCategory>( context, "Category", "TallerJAP2022KarenRubiaca");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
