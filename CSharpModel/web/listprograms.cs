...
namespace GeneXus.Programs {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "TallerJAP2022KarenRubiaca") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "TallerJAP2022KarenRubiaca") ;
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "TallerJAP2022KarenRubiaca");
         AV11name = "WWSeller";
