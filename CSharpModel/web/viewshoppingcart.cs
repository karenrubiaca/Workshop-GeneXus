...
namespace GeneXus.Programs {
   public class viewshoppingcart : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("ShoppingCartDate", context.localUtil.Format(A28ShoppingCartDate, "99/99/99"));
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11ShoppingCartId = H000C2_A11ShoppingCartId[0];
               A28ShoppingCartDate = H000C2_A28ShoppingCartDate[0];
      ...
      protected void E110C2( )
      {
         ...
         {
            A11ShoppingCartId = H000C3_A11ShoppingCartId[0];
            A28ShoppingCartDate = H000C3_A28ShoppingCartDate[0];
            AssignAttri("", false, "A28ShoppingCartDate", context.localUtil.Format(A28ShoppingCartDate, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A28ShoppingCartDate, 1, "/");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130482860", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewshoppingcart.js", "?202211130482860", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12ShoppingCartId',fld:'vSHOPPINGCARTID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A28ShoppingCartDate',fld:'SHOPPINGCARTDATE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000C2_A11ShoppingCartId = new short[1] ;
         H000C2_A28ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000C3_A11ShoppingCartId = new short[1] ;
         H000C3_A28ShoppingCartDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewshoppingcart__default(),
            new Object[][] {
                new Object[] {
               H000C2_A11ShoppingCartId, H000C2_A28ShoppingCartDate
               }
               , new Object[] {
               H000C3_A11ShoppingCartId, H000C3_A28ShoppingCartDate
               }
            }
         );
      ...
      private short[] H000C2_A11ShoppingCartId ;
      private DateTime[] H000C2_A28ShoppingCartDate ;
      private short[] H000C3_A11ShoppingCartId ;
      private DateTime[] H000C3_A28ShoppingCartDate ;
   ...
   public class viewshoppingcart__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000C3", "SELECT [ShoppingCartId], [ShoppingCartDate] FROM [ShoppingCart] WHERE [ShoppingCartId] = @AV12ShoppingCartId ORDER BY [ShoppingCartId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
