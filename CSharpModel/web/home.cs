...
namespace GeneXus.Programs {
   public class home : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130482482", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("home.js", "?202211130482483", false, true);
         }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV5MenuItem = "";
         AV6ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "TallerJAP2022KarenRubiaca");
