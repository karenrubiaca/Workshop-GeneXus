...
namespace GeneXus.Programs {
   public class viewseller : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewseller( )
      {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("SellerName", StringUtil.RTrim( context.localUtil.Format( A13SellerName, "")));
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSellerName_Internalname, StringUtil.RTrim( A13SellerName), StringUtil.RTrim( context.localUtil.Format( A13SellerName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtSellerName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5SellerId = H000A2_A5SellerId[0];
               A13SellerName = H000A2_A13SellerName[0];
      ...
      protected void E110A2( )
      {
         ...
         {
            A5SellerId = H000A3_A5SellerId[0];
            A13SellerName = H000A3_A13SellerName[0];
            AssignAttri("", false, "A13SellerName", A13SellerName);
            AV16GXLvl6 = 1;
            Form.Caption = A13SellerName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130482796", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewseller.js", "?202211130482797", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12SellerId',fld:'vSELLERID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A13SellerName',fld:'SELLERNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000A2_A5SellerId = new short[1] ;
         H000A2_A13SellerName = new string[] {""} ;
         hsh = "";
         H000A3_A5SellerId = new short[1] ;
         H000A3_A13SellerName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewseller__default(),
            new Object[][] {
                new Object[] {
               H000A2_A5SellerId, H000A2_A13SellerName
               }
               , new Object[] {
               H000A3_A5SellerId, H000A3_A13SellerName
               }
            }
         );
      ...
      private short[] H000A2_A5SellerId ;
      private string[] H000A2_A13SellerName ;
      private short[] H000A3_A5SellerId ;
      private string[] H000A3_A13SellerName ;
