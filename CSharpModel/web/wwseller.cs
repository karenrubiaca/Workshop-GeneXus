...
namespace GeneXus.Programs {
   public class wwseller : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwseller( )
      {
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSeller.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A14SellerPhoto))), !bGXsfl_25_Refreshing);
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SELLERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "SELLERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")));
      }
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4CountryName = H000B2_A4CountryName[0];
               A3CountryId = H000B2_A3CountryId[0];
               A40000SellerPhoto_GXI = H000B2_A40000SellerPhoto_GXI[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A14SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A14SellerPhoto), true);
               A13SellerName = H000B2_A13SellerName[0];
               A5SellerId = H000B2_A5SellerId[0];
               A14SellerPhoto = H000B2_A14SellerPhoto[0];
               AssignProp("", false, edtSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A14SellerPhoto))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A14SellerPhoto), true);
               A4CountryName = H000B2_A4CountryName[0];
               E140B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SELLERID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9"), context));
      }
      ...
      private void E140B2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtSellerName_Link = formatLink("viewseller.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A5SellerId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"SellerId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130482663", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwseller.js", "?202211130482663", false, true);
         }
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSellerId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSellerId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtSellerPhoto_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)1,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn WWOptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A14SellerPhoto_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
      ...
      protected void StartGridControl25( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A13SellerName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtSellerName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A14SellerPhoto));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E140B2',iparms:[{av:'A5SellerId',fld:'SELLERID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtSellerName_Link',ctrl:'SELLERNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110B2',iparms:[{av:'A5SellerId',fld:'SELLERID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11SellerName = "";
         H000B2_A4CountryName = new string[] {""} ;
         H000B2_A3CountryId = new short[1] ;
         H000B2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000B2_A13SellerName = new string[] {""} ;
         H000B2_A5SellerId = new short[1] ;
         H000B2_A14SellerPhoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwseller__default(),
            new Object[][] {
                new Object[] {
               H000B2_A4CountryName, H000B2_A3CountryId, H000B2_A40000SellerPhoto_GXI, H000B2_A13SellerName, H000B2_A5SellerId, H000B2_A14SellerPhoto
               }
               , new Object[] {
      ...
      private string[] H000B2_A4CountryName ;
      private short[] H000B2_A3CountryId ;
      private string[] H000B2_A40000SellerPhoto_GXI ;
      private string[] H000B2_A13SellerName ;
      private short[] H000B2_A5SellerId ;
      private string[] H000B2_A14SellerPhoto ;
