...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="TransactionContext.Attribute" , Namespace="TallerJAP2022KarenRubiaca" )]
	[Serializable]
	...
	[DataContract(Name=@"TransactionContext.Attribute", Namespace="TallerJAP2022KarenRubiaca")]
