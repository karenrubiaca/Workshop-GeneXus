...
namespace GeneXus.Programs {
   public class sellergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A5SellerId", StringUtil.LTrimStr( (decimal)(A5SellerId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A5SellerId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sellergeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A5SellerId,4,0))}, new string[] {"SellerId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA5SellerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA5SellerId), 4, 0, ".", "")));
      }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSellerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")), StringUtil.LTrim( ((edtSellerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9") : context.localUtil.Format( (decimal)(A5SellerId), "ZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSellerId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtSellerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "", "HLP_SellerGeneral.htm");
            ...
            GxWebStd.gx_bitmap( context, imgSellerPhoto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 1, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A14SellerPhoto_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_SellerGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000SellerPhoto_GXI = H000N2_A40000SellerPhoto_GXI[0];
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A14SellerPhoto))), true);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A14SellerPhoto), true);
               A4CountryName = H000N2_A4CountryName[0];
               AssignAttri(sPrefix, false, "A4CountryName", A4CountryName);
               A3CountryId = H000N2_A3CountryId[0];
               AssignAttri(sPrefix, false, "A3CountryId", StringUtil.LTrimStr( (decimal)(A3CountryId), 4, 0));
               A13SellerName = H000N2_A13SellerName[0];
               AssignAttri(sPrefix, false, "A13SellerName", A13SellerName);
               A14SellerPhoto = H000N2_A14SellerPhoto[0];
               AssignAttri(sPrefix, false, "A14SellerPhoto", A14SellerPhoto);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A14SellerPhoto)) ? A40000SellerPhoto_GXI : context.convertURL( context.PathToRelativeUrl( A14SellerPhoto))), true);
               AssignProp(sPrefix, false, imgSellerPhoto_Internalname, "SrcSet", context.GetImageSrcSet( A14SellerPhoto), true);
               A4CountryName = H000N2_A4CountryName[0];
               AssignAttri(sPrefix, false, "A4CountryName", A4CountryName);
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA5SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA5SellerId"), ".", ","));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A5SellerId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A5SellerId", StringUtil.LTrimStr( (decimal)(A5SellerId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA5SellerId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A5SellerId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A5SellerId", StringUtil.LTrimStr( (decimal)(A5SellerId), 4, 0));
         }
         wcpOA5SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA5SellerId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( A5SellerId != wcpOA5SellerId ) ) )
         {
            setjustcreated();
         }
         wcpOA5SellerId = A5SellerId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA5SellerId = cgiGet( sPrefix+"A5SellerId_CTRL");
         if ( StringUtil.Len( sCtrlA5SellerId) > 0 )
         {
            A5SellerId = (short)(context.localUtil.CToN( cgiGet( sCtrlA5SellerId), ".", ","));
            AssignAttri(sPrefix, false, "A5SellerId", StringUtil.LTrimStr( (decimal)(A5SellerId), 4, 0));
         }
         else
         {
            A5SellerId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A5SellerId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A5SellerId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5SellerId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA5SellerId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A5SellerId_CTRL", StringUtil.RTrim( sCtrlA5SellerId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202211130475013", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("sellergeneral.js", "?202211130475015", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A5SellerId',fld:'SELLERID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000N2_A5SellerId = new short[1] ;
         H000N2_A40000SellerPhoto_GXI = new string[] {""} ;
         H000N2_A4CountryName = new string[] {""} ;
         H000N2_A3CountryId = new short[1] ;
         H000N2_A13SellerName = new string[] {""} ;
         H000N2_A14SellerPhoto = new string[] {""} ;
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sellergeneral__default(),
            new Object[][] {
                new Object[] {
               H000N2_A5SellerId, H000N2_A40000SellerPhoto_GXI, H000N2_A4CountryName, H000N2_A3CountryId, H000N2_A13SellerName, H000N2_A14SellerPhoto
               }
            }
         );
         AV13Pgmname = "SellerGeneral";
      ...
      private string sCtrlA5SellerId ;
      ...
      private short[] H000N2_A5SellerId ;
      private string[] H000N2_A40000SellerPhoto_GXI ;
      private string[] H000N2_A4CountryName ;
      private short[] H000N2_A3CountryId ;
      private string[] H000N2_A13SellerName ;
      private string[] H000N2_A14SellerPhoto ;
   ...
   public class sellergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000N2", "SELECT T1.[SellerId], T1.[SellerPhoto_GXI], T2.[CountryName], T1.[CountryId], T1.[SellerName], T1.[SellerPhoto] FROM ([Seller] T1 INNER JOIN [Country] T2 ON T2.[CountryId] = T1.[CountryId]) WHERE T1.[SellerId] = @SellerId ORDER BY T1.[SellerId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
